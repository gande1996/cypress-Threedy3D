...
describe('SelfServe-Create Model', () => {
    ...
    it('validate exit fumctionality', () => {

        cy.navigateToCreateModel()
        /* user create a model  */
        cy.log('user create a model')
        cy.createModelDataExit(createModelData.categoryName, createModelData.modelTitleName, createModelData.skuNumber, createModelData.productURL,
            createModelData.unitOfMeasurement, createModelData.height, createModelData.width, createModelData.depth, createModelData.path)
        //cy.contains('button', 'Got it').should('be.visible').click({ force: true })
    ...
    it('validate edit fumctionality', () => {

        cy.navigateToCreateModel()
        /* user create a model  */
        cy.log('user create a model')
        cy.createModelDataEdit(createModelData.categoryName, createModelData.modelTitleName, createModelData.skuNumber, createModelData.productURL,
            createModelData.unitOfMeasurement, createModelData.height, createModelData.width, createModelData.depth, createModelData.path)
        cy.contains('button', 'Got it').should('be.visible').click({ force: true })
